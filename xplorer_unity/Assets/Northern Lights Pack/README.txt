...
For URP projects. Set the second camera as an "Overlay" camera. Set its culling mask to only include the layer the northern lights are in. 
On the main camera, add a new overlay camera to the stack.
